    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(PROFILE_PAGE_URL, FAVORITE_ARTICLES_URL, PROFILE_UPDATE_URL, PROFILE_PASSWORD_UPDATE_URL,
                        ARTICLES_PAGE_URL, ARTICLE_PAGE_URL, ARTICLE_ADD_COMMENT_URL, ARTICLE_DELETE_COMMENT_URL)
                ...
                .antMatchers(HOMEPAGE_URL, BOOTSTRAP_CONTENT_URL, FORBIDDEN_PAGE_URL, INTERNAL_ERROR_PAGE_URL)
                .permitAll()
                .and()
                .formLogin()
